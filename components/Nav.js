...
export default function Nav({show}) {
  ...
  const inactiveLink = 'flex gap-1 p-1 mr-0';
  ...
  return (
    ...
    <asider
      ...
      <nav className="flex flex-col  gap-2">
        ...
        <Link href={'/catagories'} className={pathname.includes('/catagories') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/catagories') ? activeIcon : inactiveIcon}>
        ...
        <Link href={'/Clients'} className={pathname.includes('/Clients') ? activeLink : inactiveLink}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/Clients') ? activeIcon : inactiveIcon}>
        ...
        <Link href={'/Adding-admin'} className={pathname.includes('/Adding-admin') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/Adding-admin') ? activeIcon : inactiveIcon}>
